package com.lifeistech.android.marubatu;
...
public class  MainActivity extends AppCompatActivity {
    ...
    private static final int[] PLAYER_IMAGES = {R.drawable.batu,R.drawable.maru};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayerTextView = (TextView) findViewById(R.id.textView);
        mWinnerTextView = (TextView) findViewById(R.id.textView2);
